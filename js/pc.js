/**
 * Created by 加瓦斯库瑞普特 on 2018/5/4.
 */
...
function Init(){
    ...
    for (var i=0;i<4;i++){
        ...
        aP.onclick = function(e){
            ...
            var selectPalne = new Selectplane(this.i,data);
            /*var gameStart = new Start(this.i,data);*/
        };
    }
};
//选择你的飞机
function Selectplane(index,mouse){
    aBox.innerHTML='';
    var arry=[],
    ...
    arry.find(item=>{
        item.onclick = function(){
            var startGame = new Start(index,mouse,this.src,this.biu)
        }
    })
};
//开始游戏
...
function Plane(mouse,plaeImg,aBox,index,bluSrc){
    ...
    document.onmousemove = function(e){
        e = e || window.event;
        var left_ = e.clientX-This.aPlane.width/2,
            top_ = e.clientY-This.aPlane.height/2,
            leMin = -This.aPlane.width/2,
